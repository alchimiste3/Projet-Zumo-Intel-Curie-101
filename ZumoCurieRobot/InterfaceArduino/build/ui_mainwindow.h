...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelYaw = new QLabel(centralwidget);
        ...
        labelAx = new QLabel(centralwidget);
        ...
        labelAy = new QLabel(centralwidget);
        ...
        labelAz = new QLabel(centralwidget);
        ...
        labelVx = new QLabel(centralwidget);
        ...
        labelVy = new QLabel(centralwidget);
        ...
        labelVz = new QLabel(centralwidget);
        ...
        labelRSSI = new QLabel(centralwidget);
        ...
        labelPx = new QLabel(centralwidget);
        ...
        labelPy = new QLabel(centralwidget);
        ...
        labelPz = new QLabel(centralwidget);
        ...
        actionsTableWidget = new QTableWidget(centralwidget);
        ...
        checkBoxAy = new QCheckBox(centralwidget);
        ...
        checkBoxAx = new QCheckBox(centralwidget);
        ...
        checkBoxVy = new QCheckBox(centralwidget);
        ...
        checkBoxVx = new QCheckBox(centralwidget);
        ...
        checkBoxPx = new QCheckBox(centralwidget);
        ...
        checkBoxPy = new QCheckBox(centralwidget);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_7->setText(QApplication::translate("MainWindow", "Action reconnue : ", 0));
